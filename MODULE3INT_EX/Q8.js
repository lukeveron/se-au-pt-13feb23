...
code. New messages are added, old ones are removed regularly by that code, 
...
P.P.S. We shouldn’t modify message objects, add our properties to them. As 
they are managed by someone else’s code, that may lead to bad 
consequences. */
...
console.log( "Read Message " + readMessages.has(messages[2])); 
console.log( "Read Message " + readMessages.has(messages[1])); 
console.log( "Read Message " + readMessages.has(messages[3])); 